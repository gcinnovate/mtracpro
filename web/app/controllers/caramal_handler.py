    ...
    def GET(self):
        ...
        if session.role == 'District User':
            ...
            dic = lit(
                ...
                criteria=criteria + " AND status='pending' AND report_type IN ('ras', 'car')",
                order="id desc",
        ...
        pagination_str = getPaginationString(default(page, 0), count, limit, 2, "caramalreports", "?page=")
    ...
    def POST(self):
        ...
        with db.transaction():
            if params.abtn == 'Approve Selected':
                ...
                return web.seeother("/caramalreports")
